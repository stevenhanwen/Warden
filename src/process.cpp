...
// Note: Need to get the first occurance of a app bundle, to get the overal application bundle
...
std::string group_name_for_process(const Process &process)
{
    ...
    // Fall back to just cleaning the process name if it is not part of a app bundle.
